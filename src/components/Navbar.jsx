...
const Navbar = () => {
  ...
  const profileHover = () => {
    ...
    const div = document.getElementsByClassName(
      `${styles.navOptionsExpanded}`
    )[0];
    div.style.opacity = '1';
    div.style.height = '300px';
    div.style.visibility = 'visible';

    const navOptions = document.getElementsByClassName(
      `${styles.navOptions}`
    )[0];
  };
      ...
      <div className={styles.navContainer}>
        <div className={styles.branding}>
          <Link className={styles.name} to="/">
            ...
            Sanam.<span className={styles.social}>Social</span>
          </Link>
        </div>
        ...
        <div className={styles.searchBarNav}>
          ...
          {results.length > 0 && (
            <div
              className={`${styles.resultsContainer} animate__animated animate__fadeIn`}
              ref={resultsRef}
            >
        ...
        <div
          onMouseOver={profileHover}
          onMouseLeave={profileLeave}
          className={styles.navOptionsExpanded}
        >
          <div>
